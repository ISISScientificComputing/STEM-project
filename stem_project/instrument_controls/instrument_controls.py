...
class InstrumentControls(object):
    ...
    def set_sample_rotation(self, rotation):
        ...
        self.track_function.append(FunctionWrapper("set_sample_rotation", [rotation]))
    ...
    def set_beam_position(self, x, y, z):
        ...
        self.track_function.append(FunctionWrapper("set_beam_position", [x, y, z]))
    ...
    def set_sample_position(self, x, y, z):
        ...
        self.track_function.append(FunctionWrapper("set_sample_position", [x, y, z]))
    ...
    def collect_data(self, sleep_timer):
        ...
        self.track_function.append(FunctionWrapper("collect_data", [sleep_timer]))
